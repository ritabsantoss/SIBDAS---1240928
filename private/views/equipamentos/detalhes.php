                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="passo-identificacao">
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <button type="button" class="btn btn-pink" data-bs-toggle="tab" data-bs-target="#passo-aquisicao">
                        ...
                        <div class="tab-pane fade" id="passo-aquisicao">
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <button type="button" class="btn btn-outline-secondary" data-bs-toggle="tab" data-bs-target="#passo-identificacao">
                                    <i class="fa-solid fa-arrow-left me-1"></i>Anterior
                                </button>
                                <button type="button" class="btn btn-pink" data-bs-toggle="tab" data-bs-target="#passo-fornecedor">
                                    Seguinte <i class="fa-solid fa-arrow-right ms-1"></i>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="passo-fornecedor">
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <button type="button" class="btn btn-outline-secondary" data-bs-toggle="tab" data-bs-target="#passo-aquisicao">
                                    <i class="fa-solid fa-arrow-left me-1"></i>Anterior
                                </button>
                                <button type="button" class="btn btn-pink" data-bs-toggle="tab" data-bs-target="#passo-localizacao">
                                    Seguinte <i class="fa-solid fa-arrow-right ms-1"></i>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="passo-localizacao">
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <button type="button" class="btn btn-outline-secondary" data-bs-toggle="tab" data-bs-target="#passo-fornecedor">
                                    <i class="fa-solid fa-arrow-left me-1"></i>Anterior
                                </button>
                                <button type="button" class="btn btn-pink" data-bs-toggle="tab" data-bs-target="#passo-documentacao">
                                    Seguinte <i class="fa-solid fa-arrow-right ms-1"></i>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="passo-documentacao">
                            ...
                            <?php else : ?>
                                <?php $di = 1; foreach ($documentos as $doc) : ?>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <button type="button" class="btn btn-outline-secondary" data-bs-toggle="tab" data-bs-target="#passo-localizacao">
                                    <i class="fa-solid fa-arrow-left me-1"></i>Anterior
                                </button>
                                <button type="button" class="btn btn-pink" data-bs-toggle="tab" data-bs-target="#passo-garantia">
                                    Seguinte <i class="fa-solid fa-arrow-right ms-1"></i>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="passo-garantia">
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <button type="button" class="btn btn-outline-secondary" data-bs-toggle="tab" data-bs-target="#passo-documentacao">
                                    <i class="fa-solid fa-arrow-left me-1"></i>Anterior
                                </button>
                                <button type="button" class="btn btn-pink" data-bs-toggle="tab" data-bs-target="#passo-contrato">
                                    Seguinte <i class="fa-solid fa-arrow-right ms-1"></i>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="passo-contrato">
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <button type="button" class="btn btn-outline-secondary" data-bs-toggle="tab" data-bs-target="#passo-garantia">
                                    <i class="fa-solid fa-arrow-left me-1"></i>Anterior
                                </button>
